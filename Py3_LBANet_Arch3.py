...
### Class definition for CNN Architecture 3 ###
...
Conv3_kernel_size = 10 # Kernel 'window' size of the third convolutional layer
...
# Target file name
fil = "Arch3_C1_" + str(Conv1_num_feature_maps) + "_" + str(Conv1_kernel_size) + "_" + str(Conv1_kernel_stride) + "_" + str(Conv1_max_pool_size) + \
...
class LBANet(torch.nn.Module):
    ...
    def __init__(self, data_labels, target_dev):
        ...
        self.FC1 = torch.nn.Linear(in_features=Conv3_num_feature_maps * self.C3_output_image_dim**2, out_features=FC1_output_features)
    ...
    def describe(self):
        ...
        print(" " + str(Conv3_num_feature_maps * self.C3_output_image_dim**2) + " input features, " + str(FC1_output_features) + " output features")
